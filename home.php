          ...
          <?php
           ...
           ?>
            ...
            <div class="card" style="width:300px">
                <img align="center"class="card-img-top" src="image\blood_drop_logo.jpg" alt="Card image" style="width:50%;height:150px">
                <div class="card-body">
...
<br>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <img class="img-fluid rounded" src="image\img2.jpg" alt="" >
            </div>
        </div>
        <!-- /.row -->
