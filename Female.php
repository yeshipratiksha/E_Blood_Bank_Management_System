...
<div class="font-italic">  fvbkfbnlan   <span style="color:red">*</span></div>
<div><input type="text" name="fullname" class="form-control" required></div>
</div>
<div class="col-lg-4 mb-4">
<div class="font-italic">vvshdblajbfd<span style="color:red">*</span></div>
...
<div class="row">
  <div class="col-lg-4 mb-4">
  <div><input type="submit" name="submit" class="btn btn-primary" value="Submit" style="cursor:pointer" href='Donor_Acceptor.php'></div>
  </div>
</div>
</div>
</div>
